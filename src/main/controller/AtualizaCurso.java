...
public class AtualizaCurso extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request,
        ...
        try {
            ...
            PreparedStatement stmt = conexao.prepareStatement("update cursos set nome = ?, requisito = ?, ementa = ?, " +
                    "carga_horaria = ?, preco = ? where id = ?");
            ...
            request.setAttribute("message", "O curso foi atualizado com sucesso.");
